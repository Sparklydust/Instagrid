...
class ViewController: UIViewController, UINavigationControllerDelegate {
  ...
  // The app opens with the cell 3 button style and reset the rotated action
...
extension ViewController: UIImagePickerControllerDelegate {
  ...
  func loadPhotoLibrary(setImageView imageView: UIImageView) {
    ...
    present(imageManager, animated: true)
  }

  // What to do when a ImageManager returns with a photo
  ...
  //What happens if the image picker cancels.
